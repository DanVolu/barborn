...
function MobileNav() {
  ...
  return (
    <>
      ...
      >
        <button
          className="md:hidden font-medium bg-gray-50/50 text-[#444444] hover:bg-gray-200 hover:text-gray-900 transform transition duration-500 px-4 py-2 rounded-md shadow-md"
